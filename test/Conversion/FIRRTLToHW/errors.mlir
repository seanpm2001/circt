...
firrtl.circuit "zero_width_mem" {
  firrtl.module @zero_width_mem(in %clock: !firrtl.clock, in %reset: !firrtl.uint<1>, in %r0en: !firrtl.uint<1>) {
    ...
    %c0_ui25 = firrtl.constant 0 : !firrtl.const.uint<25>
    %cc_0 = firrtl.constcast %c0_ui4 : !firrtl.const.uint<4>
    %cc_1 = firrtl.constcast %c0_ui1 : !firrtl.const.uint<1>
    ...
    firrtl.connect %2, %cc_0 : !firrtl.uint<4>, !firrtl.uint<4>
    ...
    firrtl.connect %5, %cc_0 : !firrtl.uint<4>, !firrtl.uint<4>
